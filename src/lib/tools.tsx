...
export const tools: Feature[] = [
  ...
  },
  {
    ...
    creationFields: [
      ...
      { id: 'contactDetails', name: 'Your Contact Info', type: 'text', placeholder: 'e.g., John Doe - 555-123-4567', description: 'This will be added to the brochure.' },
      { id: 'companyName', name: 'Your Company Name', type: 'text', placeholder: 'e.g., "The Doe Group"', description: 'Your company name for branding.' },
      { id: 'toneOfVoice', name: 'Tone of Voice', type: 'text', placeholder: 'e.g., Professional, Friendly', description: 'The tone for the rebranded content.' },
  ...
  },
  {
    ...
    creationFields: [
      ...
      { id: 'userBrandingPreferences', name: 'Branding Style', type: 'textarea', placeholder: 'e.g., Modern, Minimalist, Luxury', description: 'Describe the desired look and feel.' },
