  ...
  const handlePull = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
        setPulledData({
            ...
            propertyTitle: "Upgraded 5-Bed Villa in Arabian Ranches",
            propertyDescription: "A beautifully upgraded villa with a private pool and landscaped garden, perfect for families. Located in a prime spot in Arabian Ranches.",
            price: 7200000,
            imageUrls: ["https://picsum.photos/400/300?random=3", "https://picsum.photos/400/300?random=4"],
        });
        setIsLoading(false);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Generate a listing plan from the <Link href="/dashboard/tool/listing-manager" className="underline font-semibold">Listing Manager</Link>, paste it here, and the pilot will push it to Property Finder.
                </CardDescription>
            </CardHeader>
            <CardContent>
                 <Textarea
            ...
            <form onSubmit={handlePull}>
                <CardContent>
                    ...
                    <div className="flex gap-2">
                        <Input id="pullId" value={pullId} onChange={e => setPullId(e.target.value)} placeholder="e.g., PF-987654" />
