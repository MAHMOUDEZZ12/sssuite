  ...
  return (
    <footer className="relative w-full h-[500px] overflow-hidden mt-24 border-t">
      <div className="absolute inset-0">
        <div
          className="absolute w-[150px] h-[150px] bg-blue-400 rounded-full"
        ...
        <div
          className="absolute w-[200px] h-[200px] bg-yellow-300 rounded-full"
          style={{
        ...
        <div
          className="absolute w-[180px] h-[180px] bg-orange-400 rounded-full"
           style={{
        ...
        <div
          className="absolute w-[220px] h-[220px] bg-sky-300 rounded-full"
          style={{
        ...
        <div
          className="absolute w-[160px] h-[160px] bg-pink-300 rounded-full"
          style={{
        ...
        <div
          className="absolute w-[190px] h-[190px] bg-lime-300 rounded-full"
          style={{
